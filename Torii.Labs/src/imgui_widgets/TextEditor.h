...
public:
	...
	struct Glyph
	{
		...
		ImU32 mCustomColor = 0;
		bool mComment : 1;
		bool mMultiLineComment : 1;
		bool mPreprocessor : 1;
		bool mHasCustomColor : 1;

		Glyph(Char aChar, PaletteIndex aColorIndex) : mChar(aChar), mColorIndex(aColorIndex),
			mCustomColor(0), mComment(false), mMultiLineComment(false), mPreprocessor(false), mHasCustomColor(false) {}
	};
	...
	void ClearLineHighlights() { mLineHighlights.clear(); }
	void AddLineHighlight(int aStartLine, int aEndLine, ImU32 aColor);
	...
	Coordinates GetSelectionEnd() const { return mState.mSelectionEnd; }
